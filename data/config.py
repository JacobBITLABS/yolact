...
drone_vis_dataset = dataset_base.copy({
    ...
    'valid_images': './data/DroneVisSet_v0.2/jaco_DroneVis-VAL2/v0.1/', #'./data/DroneVisSet_v0.2/jaco_DroneVis-VAL2/v0.1/',
    
    'train_info': './data/DroneVisSet_v0.2/export_coco-instance_jaco_DroneVis-IMG_v0.2.json',
    'valid_info': './data/DroneVisSet_v0.2/export_coco-instance_jaco_DroneVis-IMG_v0.2.json', #'./data/DroneVisSet_v0.2/export_coco-instance_jaco_DroneVis-VAL2_v0.1.json',
